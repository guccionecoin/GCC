...
uint256 hashGenesisBlock("0x00000f7fde7ff8e728feddbc2ea40c55d9c29db9d41e7914deb0d0e9b7bff05a");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // GuccioneCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "GuccioneCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 2 * 60;	// GuccioneCoin: 2 mins 
static const int64 nTargetSpacing = 60;			// GuccioneCoin: 60 sec
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal guccionecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GuccioneCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000f7fde7ff8e728feddbc2ea40c55d9c29db9d41e7914deb0d0e9b7bff05a");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "In June 17, 2015, An American-Japanese spacecraft that was put in orbit 17 years ago is finally coming home. It is expected to fall back to earth on or about June 17. 1434507176.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1434507176;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1042949;
        ...
        assert(block.hashMerkleRoot == uint256("0x895e439603a278106acd09f2c39bd09e3cb2ae3d7ca597612058b19f7b4ed4f9"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // GuccioneCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
