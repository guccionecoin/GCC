...
static const unsigned int MAX_TX_COMMENT_LEN = 140; // GuccioneCoin: 128 bytes + little extra

static const int64 MIN_TX_FEE = 1000000;
static const int64 MIN_RELAY_TX_FEE = MIN_TX_FEE;
static const int64 MAX_MONEY = 3900000 * COIN; // GuccioneCoin: maximum of 3.9M coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 2880 / 250; // GuccioneCoin: 2880 blocks found a day. Priority cutoff is 1 guccionecoin day / 250 bytes.
    }
